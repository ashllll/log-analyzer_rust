...
fn search_query_string() -> impl Strategy<Value = String> {
    prop_oneof![
        "[a-zA-Z]{3,20}",
        ...
        fn property_highlighting_efficiency(
            ...
            let _ = rt.block_on(async {
                ...
                let test_entry = LogEntry {
                    ...
                    level: "INFO".into(),
                    file: "test.log".into(),
                    real_path: "/var/log/test.log".into(),
                    line: 1,
    ...
    async fn test_integrated_search_performance() {
        ...
        let test_entries = vec![
            LogEntry {
                ...
                line: 100,
                content: "Database connection failed".into(),
                tags: vec![],
                match_details: None,
                matched_keywords: None,
            },
            LogEntry {
                id: 2,
                timestamp: "1640995260".into(),
                level: "INFO".into(),
                file: "app.log".into(),
                real_path: "/var/log/app.log".into(),
                line: 101,
                content: "Retrying database connection".into(),
                tags: vec![],
                match_details: None,
                matched_keywords: None,
            },
