            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="ml-0.5 opacity-0 transition-[color,opacity] duration-150 group-hover:opacity-100 hover:text-status-error"
                  title="删除关键词"
