...
export const COLOR_STYLES: Record<ColorKey, ColorStyles> = {
  blue: {
    ...
    text: "text-blue-400",
    activeBtn: "bg-blue-500 text-white border-blue-400",
  ...
  green: {
    ...
    activeBtn: "bg-emerald-500 text-white border-emerald-400",
  ...
  red: {
    ...
    text: "text-red-400",
    activeBtn: "bg-red-500 text-white border-red-400",
  ...
  orange: {
    ...
    text: "text-amber-400",
    activeBtn: "bg-amber-500 text-white border-amber-400",
  ...
  purple: {
    ...
    activeBtn: "bg-purple-500 text-white border-purple-400",
