...
import { FileText, Plus, RefreshCw, Trash2, Eye, EyeOff, CheckCircle2, Settings, FolderOpen } from 'lucide-react';
    ...
    <div className="p-8 max-w-6xl mx-auto h-full overflow-auto">
      ...
      {workspaces.length === 0 ? (
        <EmptyState
          ...
          description={t('workspaces.empty_description', '导入一个文件夹或日志文件，开始分析')}
          action={{
                ...
                <div className="px-4 py-3 border-b border-border-subtle bg-bg-elevated/50 font-bold text-sm flex justify-between items-center">
                  ...
                  <div className="flex gap-1 shrink-0">
                    <Button
                      ...
                      className="h-7 w-7 p-0 text-text-dim hover:text-cta-text"
                    ...
                    <Button
                      variant="ghost"
                      icon={RefreshCw}
                      className="h-7 w-7 p-0 text-text-dim hover:text-primary-text"
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex items-center gap-2 text-xs font-bold flex-wrap">
                    {ws.status === 'READY' ? (
                      ...
                      <>
                        <RefreshCw size={14} className="text-primary-text animate-spin"/>
