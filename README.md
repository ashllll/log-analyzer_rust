...
![Version](https://img.shields.io/badge/version-1.2.10-brightgreen.svg)
...
│           └── models/             # 数据模型
├── docs/                           # 项目文档
│   ├── architecture/               # CAS 架构、API、搜索功能
│   ├── guides/                     # 用户指南
│   ├── development/                # 开发指南（CI/CD、Agents）
│   └── performance/                # 性能分析报告
└── scripts/                        # CI 验证脚本
```
...
```
导入：原始文件 → SHA-256 → 去重检查 → objects/ → SQLite 元数据
...
| [docs/development/AGENTS.md](docs/development/AGENTS.md) | AI 代理开发指南 |
